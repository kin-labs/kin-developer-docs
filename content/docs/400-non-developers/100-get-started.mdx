...
Don't have an App Index? Register your app on our [Developer Portal](https://portal.kin.org/) so you can get your App Index that allows you get credit for your transactions and earn via the KRE.
