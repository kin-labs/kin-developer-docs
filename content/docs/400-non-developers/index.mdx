...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  ...
  />
  <NavCard
    title="See What The Kin No-Code Plugin Can Do"
    subtitle="Check out all of the methods and options for using the Kin No-Code Plugin"
    svgFile="kin"
    link={{
      url: '/docs/non-developers/no-code-plugin',
      label: 'Check it out!',
    }}
  />
</div>
