...
![Add Phantom Wallet One](/images/nfts-with-kin/add-phantom-wallet-1.png)

Then, again, "Add to Chrome"

![Add Phantom Wallet to Chrome](/images/nfts-with-kin/add-phantom-wallet-2.png)

After installing, open Phantom Wallet and click the "Create New Wallet" button.

![Create New Wallet in Phantom Wallet](/images/nfts-with-kin/add-phantom-wallet-3.png)
...
- **video** [Opinion piece on the "Best 3 Text Editors for Coding" ](https://www.youtube.com/watch?v=kCZQPL8u_YI)
...
![Setting Up Metaplex Store With Kin Step One](/images/nfts-with-kin/setting-up-the-store-1.gif)

From the terminal, navigate into `metaplex/js`. Once in the folder run `yarn install && yarn bootstrap`

![Setting Up Metaplex Store With Kin Step Two](/images/nfts-with-kin/setting-up-the-store-2.gif)
...
![Setting Up Metaplex Store With Kin Step Three](/images/nfts-with-kin/setting-up-the-store-3.gif)
...
6. Add our wallet address, Kin Token Program address, and Kin token id to our project
...
![Initializing Your Metaplex Storefront](/images/nfts-with-kin/Initializing-Your-Site.gif)
...
![Connect Phantom To Metaplex](/images/nfts-with-kin/connecting-phantom-to-metaplex.gif)
...
![Ensure wallet is using the same network](/images/nfts-with-kin/troubleshooting-1.gif)
...
![Metaplex Storefront Configuration](/images/nfts-with-kin/troubleshooting-2.png)
...
![Refresh Broswer](/images/nfts-with-kin/troubleshooting-3.gif)

### Add the Store Address

To add the _Store Configuration_:

- In VS Code, or your preferred code editor, navigate to `./js/packages/web/.env` and open the .env file
...
![Adding the store address](/images/nfts-with-kin/add-the-store-address.gif)
...
![Adding creators to the Metaplex store](/images/nfts-with-kin/adding-creators.gif)
...
1. **On Solana** — where the associated token will be minted and as well as a bit of data (a Decorator Struct) that describes the NFT and, importantly, where its metadata lives
...
![KiNFT Tutorial Graphic](/images/nfts-with-kin/creating-the-nfts-1.png)

The graphic we select in this step will eventually be uploaded onto Arweave and its URL will be automatically added to the overall Metadata object.

![Upload NFT image to Arweave](/images/nfts-with-kin/creating-the-nfts-2.gif)

### Add Details

Now we'll add the NFT details.

![Adding NFT Details](/images/nfts-with-kin/creating-the-nfts-3.gif)
...
- **value** — describes an important detail about the trait_type e.g. its name, a numerical value, whether or not a condition is true or false, an SKU etc...
...
![Attribute Types](/images/nfts-with-kin/creating-the-nfts-4.png)
...
![Adding Royalties to your nfts in Metaplex](/images/nfts-with-kin/creating-the-nfts-5.png)

### Creator Splits

![Creator Splits](/images/nfts-with-kin/creating-the-nfts-6.gif)
...
![An important aside](/images/nfts-with-kin/creating-the-nfts-7.gif)
...
![Select Menu Items](/images/nfts-with-kin/mint-your-nft-1.gif)
...
![Main Edition NFTs](/images/nfts-with-kin/mint-your-nft-2.gif)
...
![Enter NFT Details](/images/nfts-with-kin/launching-nft-1.gif)
...
![Set Pricing Info](/images/nfts-with-kin/launching-nft-2.gif)
...
![Skip participation NFTs if you're not launching with one](/images/nfts-with-kin/launching-nft-3.png)
...
![Skip Participation](/images/nfts-with-kin/launching-nft-4.gif)
...
![Completing one transaction on Metaplex](/images/nfts-with-kin/launching-nft-5.gif)

The gif above only shows the first transaction. For the curious, here are what both transactions look like.

Transaction One

![Example Solana Transaction One](/images/nfts-with-kin/launching-nft-6.png)

Transaction Two

![Example Solana Transaction Two](/images/nfts-with-kin/launching-nft-7.png)
...
If you need a refresher on how to do that, [click here](#add-the-store-address).
...
For those interested in building their NFT projects using Kin, if your project is going places, you can apply for a [Kin Foundation Catalyst Fund grant here](https://rebrand.ly/kin-funding).
