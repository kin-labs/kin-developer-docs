...
<div>
  ...
  <input className='KREChecklistCheckbox' type="checkbox" id="terms" name="terms" value="terms"/>
  <label for="terms">Developer is in compliance with the Kin Foundation <a href="https://kin.org/terms-of-use-agreement/">Terms of Use</a> and <a href="https://kin.org/kin-developer-terms/">Developer Terms</a></label>
</div>
