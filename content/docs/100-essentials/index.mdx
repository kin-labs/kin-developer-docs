...
1. Become part of a [thriving digitial economy](https://kin.org/kin-apps)
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <NavCard
    title="Kin Branding"
    subtitle="Access Kin branded assets and read our branding guidelines."
    svgFile="kin"
    link={{ url: '/docs/essentials/branding', label: 'Check it out' }}
  />
</div>
