...
Commitment is the level of certainty that a specific block has been written permanently to the blockchain. E.g. a 'Processed' block could in theory end up being rejected and so the transaction wouldn't go through. This is rare. 'Finalized' gives total certainty but takes longer to return. 'Confirmed' is a middle option. See [here](https://docs.solana.com/cluster/commitments) for more details.
...
Kin Transactions can be recorded as a number of different types: [Spend](/docs/essentials/terms-and-concepts#spend), [Earn](/docs/essentials/terms-and-concepts#earn), [P2P](/docs/essentials/terms-and-concepts#p2p).
