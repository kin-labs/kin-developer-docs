...
Kin's SDKs connect apps to the blockchain through an open source project called Kinetic.

Kinetic is a powerful suite of tools that make it easy to build apps that integrate Solana.
