...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <NavCard title="Learn more about Kinetic" svgFile="kin" link={{ url: '/docs/kinetic', label: 'See more...' }} />
</div>
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  ...
  <NavCard title="Python" pngFile="python" link={{ url: '/docs/developers/python', label: 'See more' }} />
  <NavCard title="Flutter (Dart)" pngFile="dart" link={{ url: '/docs/developers/flutter-dart', label: 'See more' }} />
  <NavCard title="iOS" pngFile="swift" link={{ url: '/docs/developers/ios-swift', label: 'See more' }} />
  <NavCard title="Android" pngFile="kotlin" link={{ url: '/docs/developers/android-kotlin', label: 'See more' }} />
