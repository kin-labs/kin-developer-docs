...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <NavCard
    ...
    pngFile="heroku"
    link={{ url: '/docs/developers/kinetic-deployment#deploying-kinetic-to-heroku', label: 'Time to Deploy!' }}
  />
  <NavCard
    title="Run Kinetic Locally"
    svgFile="docker-brands"
    link={{ url: '/docs/developers/kinetic-deployment#running-kinetic-locally', label: 'Go Local' }}
  />
</div>
