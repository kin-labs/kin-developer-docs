...
Here we'll explain how you can deploy your own Kinetic instance to Heroku and how to run Kinetic locally.
...
Go to Settings / Config Vars and add your environment variables as you would have in your `.env` file when [running Kinetic locally](/docs/developers/kinetic-deployment#prepare-your-environment-variables).<br/>
