...
You can also deploy directly onto a server using [Azure](https://azure.microsoft.com/en-us/), [Digital Ocean](https://www.digitalocean.com/), etc. Check out our [starter apps](/docs/developers/kinetic-hosting#demos-and-starter-kits) below if you want to get going quickly and know your way around a server.
