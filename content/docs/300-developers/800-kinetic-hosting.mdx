...
Go to Settings / Config Vars and add your environment variables as you would have in your `.env` file when [running Kinetic locally](/docs/developers/kinetic-hosting#prepare-your-environment-variables).<br/>
