...
<DemoContainer
  stages={[
    ...
    },
    {
      ...
      subtitle:
        'Use Kinetic to create a keypair. This will act as your wallet on the blockchain. The mnemonic code for the keypair can be imported into any Solana wallet such as Phantom or Solflare.',
